...
input_path = "file:///Users/tangqiliang/Documents/工作/data_repair/register_company/input2"
...
cleaned_df = spark.sql("""
    select substr(`@timestamp`, 0, 10) d,
        count(if((
        (referer like '%register?version=2%' AND tag = "RegistrationController@registerCompany")
...
output_path = "file:///Users/tangqiliang/Documents/工作/data_repair/register_company/output2"
